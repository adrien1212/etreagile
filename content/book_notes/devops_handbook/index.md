...
### 1. Fast flow of work
Pour maximiser le flux de travail et livrer le plus rapidement, nous devons respecter les points cités ci-dessous
...
Les auteurs du livre s'appuient sur de nombreuses références pour montrer que les personnes qui commettent des erreurs ne doivent pas être punies et celles qui soulèvent des problèmes en suggérant des pistes d'amélioration ne doivent pas être vues comme des perturbateurs. Les équipes qui achèvent une "High performance" sont celles qui favorisent une [culture de confiance]({{< relref "philosophie_agile/comment/importance_culture" >}}).

> "name, blame and shame" crée automatiquement des extra-processes ([cause de gaspillage]({{< relref "philosophie_lean/lean_software_developement/elimite_gaspillage" >}})) et approbations superflues pour prévenir des erreurs 

Le Dr. Ron Westrum a été l'un des premiers à observer l'importance de la culture d'entreprise sur la sécurité et la performance. Il a établi [3 types d'organisations]({{< relref "philosophie_agile/comment/importance_culture" >}})
...
Tous ces éléments sont également repris dans le livre [Accelerate]({{< relref "Accelerate/index" >}}) et dans la section [Psychological Safety]({{< relref "philosophie_agile/comment/importance_culture/psychological_safety" >}})

### Conclusion
Au final développer une culture d'entreprise de confiance va nous permettre l'apprentissage continu et d'expérimenter sans avoir peur de se tromper ou de soumettre de nouvelles idées. Et ceci est crucial pour améliorer le flux de travail et les boucles de feedback
