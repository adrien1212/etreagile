...
Dans la [section précédente]({{< relref "equipe_agile/roles_postures/developpeur_executant/index" >}}), nous évoquions l'aménagement du temps pour les personnes ACTIVES de l'entreprise. Et cette idée vient parfaitement se compléter avec une section du Chapitre 5 du livre [The DevOps Handbook](book_notes/devops_handbook/index)
...
J'ai volontairement mis *YYY* car le livre The DevOps handbook se concentre sur la mise en place de la philosophie DevOps, mais *YYY* peut être remplacé par n'importe quel sujet (Agile, microservices, etc ...). 
...
Les phases idéales pour propager *YYY* à toute une organisation
...
En lien également avec le changement de la culture dans une organisation [Accelerate - Comment changer la culture ?]({{< relref "pratiques/devops/accelerate/#comment-changer-la-culture-" >}})