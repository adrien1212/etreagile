...
Le Product Backlog est une **liste ordonnée** et **émergente** d’user-stories qui contiennent
une brève description de quelle est l’exigence, qui en a besoin et pourquoi elle est nécessaire.

Il consiste en un **plan provisoire à un instant t pour atteindre le Product Goal**.
Le Product Backlog n’est jamais fini. Au commencement, nous y positionnons les fonctionnalités requises connues puis il évolue au fil du développement du produit.
...
Il faut éviter que le PO crée le Product Backlog dans son coin avec un ensemble de tâches
à faire
...
Le Product Backlog change/évolue dans l’unique but d’atteindre le Product Goal. En fonction du Product Goal on ordonne le Product Backlog

## Un Product Backlog n’a pas un temps défini
Des exigences sont ajoutées au Product Backlog tant que nous n’avons pas atteint ou abandonné
le Product Goal
