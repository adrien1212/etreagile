...
Cette dernière section sur Scrum est un ensemble de notes que j'ai trouvées intéressantes lors de la lecture du livre *Scrum: The Art of Doing Twice the Work in Half the Time*
...
- Scrum is based on: Toyota. And, more specifically, Taiichi Ohno’s Toyota Production System.
  ...
  - Management’s key task is to identify and remove impediments to that flow.
...
=> En d'autres termes il faut identifier et résoudre ce qui nous a ralenti 
...
Avec Scrum on ne se concentre pas sur les performances individuelles, on cherche à créer la meilleure équipe. Ainsi on peut se demander qu'est-ce qui caractérise une bonne équipe et comment pouvons-nous le reproduire ?
...
On peut également se poser la question de la taille de l'équipe, la Loi de Brooks que nous avons déjà évoquée nous dit *adding manpower to a late software project makes it later*
...
Pourquoi ajouter du monde à un projet ne le rend pas plus rapide ?
