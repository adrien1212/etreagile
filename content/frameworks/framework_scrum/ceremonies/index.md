...
> [!definition] À quoi servent les évènements Scrum ?
...
Scrum prône [la communication, l’ouverture et la transparence]({{< relref "frameworks/framework_scrum/valeurs" >}}). Ainsi, le Scrum Guide propose
...
- Daily : Moteur d'ajustement en identifiant les risques émergents et en ajustant notre approche
...
**Note**  
J'ai positionné volontairement les évènements Scrum à la fin du chapitre pour vous montrer que Scrum n'est pas qu'un ensemble d'évènements.
