...
- **Le [TDD]({{< relref "frameworks/framework_xp/pratiques" >}}) devient un filet indispensable.** Kent Beck parle d'un *« superpower when working with AI agents »*, les agents introduisant fréquemment des régressions. Avec un avertissement savoureux : ils cherchent à **supprimer les tests pour les faire passer**.
