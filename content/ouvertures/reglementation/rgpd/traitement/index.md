...
> Toute opération ou tout ensemble d'opérations, effectuée(s), ou non, à l'aide de procédés automatisés, et appliquée(s) à des données ou des ensembles de données à caractère personnel.

![Traitement données peronnelles](traitement.png)
