...
- de la [réglementation]({{< relref "ouvertures/urbanisation/reglementation/index" >}}) (RGPD, ISO 27001, etc.)
...
Dire *l’EA aligne le business et l’IT*, c’est joli ... mais ça ne dit pas ce que les architectes produisent réellement. C’est exactement ce que vient adresser [CSVLOD]({{< relref "ouvertures/urbanisation/csvlod/index" >}}) :
