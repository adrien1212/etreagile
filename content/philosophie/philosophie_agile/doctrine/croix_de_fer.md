...
Avec cette approche vous augmentez votre dette technique (voir [La qualité vaut-elle le coût ?]({{< relref "philosophie/philosophie_agile/pourquoi/qualite_logicielle/index" >}})) et vous vous retrouvez quelques années après avec un logiciel difficilement maintenable et évolutif. 
