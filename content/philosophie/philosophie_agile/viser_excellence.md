...
De plus, [eXtreme Programming]({{< relref "frameworks/framework_xp/index" >}}) dès 1999 fait le lien entre les deux sphères en proposant le TDD, la Continuous Integration comme pratiques techniques.
...
Ce qui conduira à l'émergence du [software craftsmanship]({{< relref "pratiques/software_craftsmanship/index" >}}).
...
- Les pratiques techniques influencent l'organisation, comme évoqué dans [l'importance de la culture]({{< relref "equipe_agile/culture/index" >}}).
...
> - A [generative]({{< relref "equipe_agile/culture#3-types-de-cultures" >}}), performance-oriented culture (see Chapter 3)
