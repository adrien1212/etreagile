...
description = "Ce qui sépare concrètement une conduite de projet traditionnelle d'une conduite agile, et ce que disent les taux de réussite."
weight = 20
+++
...
C'est ce que formalise le [triangle de fer et sa contrepartie agile, la croix de fer]({{< relref "philosophie/philosophie_agile/croix_de_fer" >}}) : ce qu'on fixe d'un côté, on doit l'ajuster de l'autre.

| Traditionnelle      | Agile                                             |
| ------------------- | ------------------------------------------------- |
| Périmètre : fixe    | Périmètre : peut changer (écoute du client)        |
...
Lorsqu’un logiciel va être **soumis à beaucoup de changements**, il est intéressant de se pencher sur une utilisation Agile
