+++
title = "Les quatre cycles de vie"
...
> [!definition] Définition
> Permet un retour d’information visant à améliorer et à modifier le travail inachevé ou partiellement achevé.
...
> [!definition] Itératif : on refait
> Avec le développement itératif, nous réservons du temps pour améliorer ce que nous avons. ⇒ **On refait.**
...
⇒ Création fréquente de la valeur. Lorsque les exigences semblent changer régulièrement, il est intéressant de se rapprocher de ce cycle en proposant au client des livraisons régulières afin qu’il valide le travail réalisé.
...
Le chef de projet peut donc facilement prévoir l’avancée du projet.
...
de différentes phases d’examen (itératif) et est intégré une fois terminé. Le tout est ensuite prêt à être
déployé.

**Note :**  
Aujourd’hui, par abus de langage lorsqu’on parle de *développement itératif* on évoque à la fois l’aspect itératif et incrémental, sans faire aucune différence. C’est malheureusement regrettable pour
...
Cette distinction n'est pas académique : elle répartit les deux premières raisons de devenir agile.

| | Ce qu'on fait | À quelle raison cela répond |
| --- | --- | --- |
| **Itératif** | On refait, on améliore ce qui existe | [Encaisser l'incertitude]({{< relref "philosophie/pourquoi_agile/encaisser_incertitude/index" >}}) — chaque passage transforme une hypothèse en fait observé |
| **Incrémental** | On ajoute une tranche livrable | [Encaisser le changement]({{< relref "philosophie/pourquoi_agile/encaisser_changement" >}}) — on ajuste les exigences à mesure que l'environnement bouge |

La suite — [le cycle de vie Agile]({{< relref "philosophie/pourquoi_agile/encaisser_incertitude/cycle_de_vie_agile" >}}) — montre comment les frameworks combinent les deux.
