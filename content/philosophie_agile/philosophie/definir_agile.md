...
Agile ce n'est pas Scrum, ce n'est pas Kanban. Agile est simplement une déclaration de [quatre valeurs]({{< relref "philosophie_agile/philosophie/manifeste" >}}). Ces quatre valeurs résument les [*pourquoi?*]({{< relref "philosophie_agile/pourquoi/index" >}}) abordés en début de chapitre.
...
- *La collaboration avec les clients plus que la négociation contractuelle* car [l'implication du client]({{< relref "philosophie_agile/pourquoi/implication_client" >}}) est nécessaire pour créer un [produit de haute qualité]({{< relref "philosophie_agile/pourquoi/produit_haute_qualite" >}})
