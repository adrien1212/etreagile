...
> [!ressource] Ressource
> - [Value is What You Like](https://ronjeffries.com/xprog/articles/value-is-what-you-like/)
> - [An Agile focus on value](https://agilealliance.org/an-agile-focus-on-value/)
...
> In Ron Jeffries’s [The Card, Conversation, Confirmation]({{< relref "user_stories/user_stories_mapping/les_3c" >}}), he proposes that user stories are “social” instead of “documentary” requirements. Consider this an extension of that approach for a question-based, non-linear maturity assessment. It’s more about your team’s discussions on how to offer more value rather than the questions themselves. [^1]
