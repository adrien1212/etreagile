...
En suivant la philosophie Agile, cette Roadmap ne doit pas être un plan qu'on va suivre scrupuleusement. Une roadmap est un ensemble de chemins divers permettant d’atteindre un but.

> Une roadmap n’est pas une série de jalons à suivre (sinon ça s’appelle un planning). 
...
Dans de nombreuses Roadmaps on retrouve un ensemble de fonctionnalités qui vont être développées dans les prochains mois/années mais en réalité dans la vie d'un logiciel *on découvre le besoin* avec le temps. De plus on peut se retrouver avec des imprévus qui nous obligent à revoir nos priorités (concurrence, réglementation, etc ...). Et finalement les estimations réalisées en amont sont rarement justes.
