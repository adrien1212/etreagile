...
> - [Section sur DORA Report]({{< relref "pratiques/devops/dora/index" >}})
...
Avant de déployer une approche pour augmenter les performances, nous devons comprendre les [impacts de la culture d'entreprise]({{< relref "equipe_agile/culture/index" >}}) et comment celle-ci doit évoluer. Les travaux de Westrum nous apprennent qu'il existe plusieurs types d'organisations et nous devons viser la *Generative*
...
> Thus we hypothesize that, following the theory developed by the Lean and Agile movements, implementing the practices of these movements can have an effect on culture. [...] Our research shows that [Lean management]({{< relref "philosophie/philosophie_lean/index" >}}),
...
J'aimerais compléter en ajoutant que le changement de culture peut être amené par des [Innovators and Early Adopters]({{< relref "equipe_agile/roles_postures/developpeur_executant/innovators_early_adopter" >}}) si on leur laisse la liberté de proposer des idées.
...
- nécessite des équipes [pluridisciplinaires]({{< relref "frameworks/framework_scrum/caracteristique" >}})
...
Nous avons dédié un chapitre au [Lean]({{< relref "philosophie/philosophie_lean/index" >}}), ici nous revenons seulement sur les points clés :
- Limiter le [WIP]({{< relref "frameworks/framework_kanban/principes" >}}) => éviter la surcharge et le multi-tâches
- [Management visuel]({{< relref "pratiques/pilotage/management_visuel" >}})
