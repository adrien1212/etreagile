...
Les organisations se sont emparées de Agile comme la solution à leurs problèmes mais n'ont jamais réellement changé *“Agile” ideas are applied poorly*
...
Ron Jeffries rejoint les mots de Kent Beck qui souhaitait créer (avec Agile) un monde meilleur pour les développeurs

> Kent Beck said over a decade ago. *I would like the world to be safe for developers.*

Cet article s'adresse donc aux développeurs pour qu'ils prennent conscience de cette mauvaise utilisation du terme Agile dans les organisations ("le fake Agile"). Ron Jeffries incite chaque développeur à se former sur "comment faire un logiciel"
...
Lorsqu'il parle d'apprentissage, il souhaite que les développeurs se forment à créer un logiciel opérationnel, suivre les bonnes pratiques de développement et apporter de la valeur de manière régulière
...
Il souhaite ainsi avoir une équipe auto-organisée qui est capable de choisir son processus de fonctionnement car elle a compris comment créer un logiciel
...
Grâce à sa **connaissance**, elle peut très bien choisir un processus déjà existant ou en créer un nouveau, prendre des pratiques et en rejeter d'autres. Cette **conscience** lui permet d'avoir le choix de choisir comment travailler
...
Mais il reproche aux entreprises d'utiliser uniquement le terme Agile sans y appliquer les valeurs et les principes. À mon sens Agile n'est pas une utopie, mais dans de nombreuses organisations il n'y a jamais eu la volonté de changement, le top management pensait qu'Agile allait résoudre *des* problèmes sans opérer de changement dans le fonctionnement organisationnel de l'entreprise. Agile doit commencer par un changement initié par le haut (la direction) et non être appliqué par le bas (le développement)
