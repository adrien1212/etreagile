...
L'estimation est une activité principale et prenante dans la gestion de projet classique. Mais qu'en est-il lorsqu'on parle d'agilité et qu'on utilise un framework comme Scrum ?
...
Derrière les bénéfices se cachent les parties prenantes, notre principale raison d'estimer est la satisfaction des parties prenantes qui ont une vision plus claire de l'avancement du projet et des dates potentielles d'achèvement, ce qui favorise la confiance et la transparence.
...
En détenant la vélocité de l'équipe nous pouvons déterminer la quantité de travail qui pourra être accompli durant l'itération. 
...
Agile se concentre sur apporter de la valeur au client. Et si on n'y fait pas attention les estimations vont nous conduire à réaliser des US qui respectent uniquement un Coût/Délais mais sans se poser la question si ces US sont celles qui apportent de la valeur au client.
*On va mettre cette US dans le Sprint car elle rentre et non car elle apporte de la valeur*. Par exemple si la vélocité est de 30, je vais prioriser pour prendre des US qui vont me donner 30 sans regarder la valeur réelle.
...
### Une estimation comprise comme un engagement
Souvent une estimation est considérée comme un engagement, ainsi la partie commerciale s'engage auprès du client en annonçant que la feature sera finie dans 1 mois (en suivant nos estimations), mais que se passera-t-il si nous n'y arrivons pas à temps ? 
...
Également, en estimant on va créer indirectement une planification qui sert de Roadmap, l'objectif va donc être de coller à la Roadmap et par conséquent s'interdire des opportunités (e.g. cette fonctionnalité serait incroyable mais comme pas dans la Roadmap ...). La Roadmap nous bloque à livrer les features qu'on a promises.

### Conclusion
Les estimations impliquent une manière de travailler qui peut se révéler toxique :
- on ne se concentre pas sur les choses qui apportent le plus de valeur
- on pense que les estimations sont des engagements
- on bride l'équipe à faire uniquement ce qui a été prévu dans la Roadmap
...
- découper si l'US est trop grosse
...
Il est tout à fait normal d'avoir des contraintes dures à notre projet (e.g. un budget, une date car un évènement présent à cette date). *Agile Estimating and Planning* fait le tour de cette question.

Scrum nous apporte également un élément de réponse, l'équipe s'engage *à produire un Incrément qui respecte le Sprint Goal et la qualité définie par la Definition of Done*. Ainsi en ayant une vision d'un objectif orienté sur la valeur, l'équipe aura choisi les US les plus propices pour atteindre le Sprint Goal. L'équipe ne s'est donc pas engagée sur un nombre d'US à finir ou sur une vélocité à maintenir mais sur la valeur à produire.

> [!affirmation] Affirmation
> L'une des principales raisons de l'estimation réside dans les conversations qui en découlent pour déterminer la taille des US.  
