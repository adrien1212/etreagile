...
- Puis dans le livre User Story Mapping, Jeff Patton écrit *Shared documents aren't shared understanding*. Ce sont les *conversations* qui vont nous amener à nous comprendre
- Et dans les références au TDD, on lit souvent que les tests sont la meilleure des documentations

Alors, on peut se demander si dans un contexte Agile la documentation est toujours nécessaire ?

### Retour sur la valeur Agile
L'affirmation « Working Software over Comprehensive Documentation » **était destinée à éviter** un problème spécifique. Dans le cas d'un projet en cascade, les phases de *Spécification*, d'*Analyse* et de *Conception* aboutissent à **des documents de spécification, d'analyse et de conception**.   
...
### Les User Stories
Les récits d'utilisateurs sont souvent un outil efficace pour saisir ce que les utilisateurs finaux doivent pouvoir réaliser avec le système, en soi, un bon support pour les conversations entre l'équipe et les parties prenantes et au sein de l'équipe. Mais les US ne sont pas adaptées pour documenter l'état du système à long terme.


## Approches en matière de documentation
Nous avons donc besoin de documenter notre produit, mais comment?, il existe plusieurs approches pour créer une documentation et la tenir à jour ([source](https://pm.stackexchange.com/a/35084/55523))
...
La documentation doit faire partie de la [Definition of Done]({{< relref "definition_of_done" >}}) pour chaque incrément. En faisant partie de la DoD, la documentation devient un ensemble de tâches pérennes pour chaque fonctionnalité ou changement au cours du développement, au lieu d'être un élément qui doit être suivi séparément ou conservé comme données historiques. On évite ainsi qu'elle devienne non-maintenue et donc obsolète.
