...
- En plus des pratiques organisationnelles il faut également des pratiques techniques (e.g. TDD, Architecture) => [Software Craftsmanship]({{< relref "pratiques/software_craftsmanship/index" >}})
...
Après presque 30 ans d'existence on peut dire que ces pratiques sont ancrées dans les entreprises. Toute entreprise, toute équipe se revendique Agile. Néanmoins l'agilité est souvent [cantonnée à l'équipe de développement]({{< relref "equipe_agile/culture/organisation_agile" >}}). 

La majorité des personnes comprennent les outils et les process autour de Agile mais peu sont capables d'influencer la [culture d'entreprise]({{< relref "equipe_agile/culture/" >}}). Or comme déjà souligné, sans un déclic sur la culture de l'organisation, l'entreprise ne deviendra jamais Agile.