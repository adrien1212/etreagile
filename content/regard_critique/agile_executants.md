...
Nous avons déjà abordé le fait que l'agilité vise à créer des équipes qui seront [actrices du produit (*developer*)]({{< relref "equipe_agile/roles_postures/developpeur_executant/index" >}}). La question soulevée ici est de savoir comment gérer une organisation ou une équipe constituée (presque) exclusivement d’exécutants.
