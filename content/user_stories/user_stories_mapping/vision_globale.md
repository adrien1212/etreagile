...
L’équipe entière va se rendre compte de problématiques sous-jacentes et cela va entraîner la création de
nouvelles users-stories. Pour ce faire, les acteurs du projet vont se réunir et discuter du produit. Ces discussions vont conduire à la réalisation d'une carte qui fera office de document et où chaque carte permettra de se rappeler de la conversation que nous avons eue.

## 1. Formulez votre idée
La première conversation est orientée business et objectif. 
...
Nous allons discuter puis écrire sur des cartes nos pensées. Ces cartes représentent l'utilisation du système, les fonctionnalités à développer, etc ... Cette conversation se concentre un peu plus sur les détails de notre produit.
...
Finalement, nous allons discuter des détails et options. Les cartes que nous plaçons en haut de chacune des colonnes deviennent des *big things*. Puis les détails
